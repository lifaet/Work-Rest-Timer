...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 1, Nuitka_PyInt_FromLong(5));
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 2, Nuitka_PyInt_FromLong(7));
    ...
    if (_Py_PackageContext != NULL) {
        ...
        main_name = Nuitka_String_FromString("__main__");
    }
#else
