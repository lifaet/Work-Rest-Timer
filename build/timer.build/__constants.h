...
// 'close'
#define const_str_plain_close global_constants[68]
// 'getattr'
#define const_str_plain_getattr global_constants[69]
// '__cached__'
#define const_str_plain___cached__ global_constants[70]
// 'print'
#define const_str_plain_print global_constants[71]
// 'end'
#define const_str_plain_end global_constants[72]
// 'file'
#define const_str_plain_file global_constants[73]
// 'bytes'
#define const_str_plain_bytes global_constants[74]
// '.'
#define const_str_dot global_constants[75]
// '_'
#define const_str_underscore global_constants[76]
// '__loader__'
#define const_str_plain___loader__ global_constants[29]
// 'send'
#define const_str_plain_send global_constants[77]
// 'throw'
#define const_str_plain_throw global_constants[78]
// 'site'
#define const_str_plain_site global_constants[79]
// 'type'
#define const_str_plain_type global_constants[80]
// 'len'
#define const_str_plain_len global_constants[81]
// 'range'
#define const_str_plain_range global_constants[34]
// 'repr'
#define const_str_plain_repr global_constants[82]
// 'int'
#define const_str_plain_int global_constants[83]
// 'iter'
#define const_str_plain_iter global_constants[84]
// '__spec__'
#define const_str_plain___spec__ global_constants[85]
// '_initializing'
#define const_str_plain__initializing global_constants[86]
// 'parent'
#define const_str_plain_parent global_constants[87]
// 'types'
#define const_str_plain_types global_constants[88]
// 'ascii'
#define const_str_plain_ascii global_constants[89]
// 'punycode'
#define const_str_plain_punycode global_constants[90]
// '__main__'
#define const_str_plain___main__ global_constants[91]
// 'as_file'
#define const_str_plain_as_file global_constants[92]
// 'register'
#define const_str_plain_register global_constants[93]
// '__class_getitem__'
#define const_str_plain___class_getitem__ global_constants[94]
// 'reconfigure'
#define const_str_plain_reconfigure global_constants[95]
// 'encoding'
#define const_str_plain_encoding global_constants[96]
// 'line_buffering'
#define const_str_plain_line_buffering global_constants[97]
// '__match_args__'
#define const_str_plain___match_args__ global_constants[98]
// '__aenter__'
#define const_str_plain___aenter__ global_constants[99]
// '__aexit__'
#define const_str_plain___aexit__ global_constants[100]
// 'split'
#define const_str_plain_split global_constants[101]
// 'fileno'
#define const_str_plain_fileno global_constants[102]
#endif
